...
def test_date_by_adding_business_days_3():
    # Handling of a non date input
    input_date = "ABC"
    with pytest.raises(SystemExit) as pytest_wrapped_e:
        actual_result = date_by_adding_business_days(input_date, 2)
...
def test_evaluate_model_2():
    ...
    inputs = {
        'DATE': ['ABC', '2019-05-02', '2019-05-03', '2019-05-06', '2019-05-07', '2019-05-08',
                 '2019-05-09', '2019-05-10', '2019-05-13', '2019-05-14', '2019-05-15', '2019-05-16'],
        'EUR': [0.88, 0.88, 0.90, 0.89, 0.91, 0.91, 0.92, 0.91, 0.91, 0.90, 0.91, 0.89],
        'GBP': [0.78, 0.81, 0.8, 0.79, 0.795, 0.798, 0.785, 0.777, 0.782, 0.788, 0.804, 0.79],
        'INR': [69.27, 69.30, 69.98, 69.56, 69.24, 69.11, 69.32, 69.41, 69.64, 69.83, 69.44, 69.22],
...
def test_ARIMAForecasting_2():
    # Test garbage values are handled
    inputs = "ABC" #Pass input as a garbage value
    with pytest.raises(SystemExit) as pytest_wrapped_e:
        actual_result = ARIMAForecasting(inputs, 7, 2, 1, 0)

    assert pytest_wrapped_e.type == SystemExit


def test_find_best_model_1():
    # Test that the output is correct when proper values are passed
    inputs = {
        'P': [1, 0, 0, 2, 0],
        'D': [1, 1, 1, 1, 1],
...
def test_generate_predictions_1():
    # Test that the output is correct when proper values are passed
    inputs = {
...
def test_generate_predictions_2():
    # Test garbage values are handled
    inputs = {
        'DATE': ['2019-05-22', '2019-05-23', '2019-05-24', '2019-05-27', '2019-05-28', '2019-05-29',
                 '2019-05-30', '2019-05-31', '2019-06-03', '2019-06-04', '2019-06-05', '2019-06-06'],
    ...
    forecast_period = "ABC" #Pass a garbage value in forecast_period
